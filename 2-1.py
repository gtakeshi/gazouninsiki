...
try :
    for train_size in train_sizes:
        """ここで､train_sizeに合わせて､訓練データの量は6000から60000まで6000ずつ増やしていく"""
        trData, trData2, trLabels,trLabels2 = train_test_split(np.array(X_60000), y_train, test_size=train_size, random_state=10)
        start = time.time()
